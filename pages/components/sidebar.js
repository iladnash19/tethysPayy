    ...
    return (
        <div className="md:w-3/12 w-5/12 h-full shadow-md">
            <div className=" border-b py-3 mt-1 flex justify-around ">
                <p className="text-xl  font-semibold">Pawcoin</p>
                <p>|</p>
                ...
                <div className="space-y-4" >
                    ...
                    <div className="">
                        <div className="flex p-3 text-gray-700  space-x-4 0 hover:bg-gray-50 hover:text-blue-600  cursor-pointer  ">
                            ...
                            <a href='https://poocoin.app/tokens/0x03f20f2dd52a2c6d0a6811d53028915c55f7509c' className=" font-semibold  " >Poocoin</a>
                        </div>
                    </div>
                    <div className="">
                        <div className="flex p-3 text-gray-700  space-x-4 0 hover:bg-gray-50 hover:text-blue-600  cursor-pointer  ">
                ...
                <div className="space-y-6" >
                    ...
                    <div className="">
                        <div className="flex p-3 text-gray-700  space-x-4 0 hover:bg-gray-50 hover:text-blue-600  cursor-pointer  ">
                            ...
                            <a className=" font-semibold " href=''>Twitter</a>
                        </div>
                    </div>
                    <div className="">
                        <div className="flex p-3 text-gray-700  space-x-4 0 hover:bg-gray-50 hover:text-blue-600  cursor-pointer  ">
                            <SocialIcon network="telegram" style={{ height: 35, width: 35 }} />
                            <a className=" font-semibold "  href='https://t.me/pawcoin'>Telegram</a>
                        </div>
                    </div>
                    ...
                    <div className="">
                        <div className="flex p-3 text-gray-700  space-x-4 0 hover:bg-gray-50 hover:text-blue-600  cursor-pointer  ">
                            ...
                            <a href='https://www.paaaaaaaw.com/' className=" font-semibold " >Website</a>
                        </div>
                    </div>
